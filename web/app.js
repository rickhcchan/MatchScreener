    ...
    h("div", { class: "stats-grid" }, [
      h("div", { class: "stats-col" }, [
        ...
        ...(homeN > 0 ? [
          ...
          h("div", { class: "stat" }, ["Average Goals Scored: ", h("strong", {}, home.avg_goals_scored != null ? home.avg_goals_scored.toFixed(2) : '-')]),
          h("div", { class: "stat" }, ["Average Goals Conceded: ", h("strong", {}, home.avg_goals_conceded != null ? home.avg_goals_conceded.toFixed(2) : '-')]),
          h("div", { class: "stat" }, ["Home 2+ Goals Scored: ", h("strong", {}, (typeof home.home_scored_2plus_pct === 'number' ? percent(home.home_scored_2plus_pct) : '-'))]),
          h("div", { class: "stat" }, ["Away 2+ Goals Scored: ", h("strong", {}, (typeof home.away_scored_2plus_pct === 'number' ? percent(home.away_scored_2plus_pct) : '-'))]),
          //h("div", { class: "stat" }, `Win / Win Others: ${typeof home.wins_count === 'number' ? home.wins_count : '-'} (${typeof home.wins_pct === 'number' ? percent(home.wins_pct) : '-'}) / ${typeof home.wins_others_count === 'number' ? home.wins_others_count : '-'} (${typeof home.wins_others_pct === 'number' ? percent(home.wins_others_pct) : '-'})`),
          //h("div", { class: "stat" }, `Draw / Draw Others: ${typeof home.draws_count === 'number' ? home.draws_count : '-'} (${typeof home.draws_pct === 'number' ? percent(home.draws_pct) : '-'}) / ${typeof home.draws_others_count === 'number' ? home.draws_others_count : '-'} (${typeof home.draws_others_pct === 'number' ? percent(home.draws_others_pct) : '-'})`),
          //h("div", { class: "stat" }, `Lost / Lost Others: ${typeof home.losses_count === 'number' ? home.losses_count : '-'} (${typeof home.losses_pct === 'number' ? percent(home.losses_pct) : '-'}) / ${typeof home.losses_others_count === 'number' ? home.losses_others_count : '-'} (${typeof home.losses_others_pct === 'number' ? percent(home.losses_others_pct) : '-'})`),
          h("div", { class: "stat" }, [
            "Win / Win Others: ",
            h("strong", {}, (typeof home.wins_pct === 'number' ? percent(home.wins_pct) : '-')),
            " / ",
            h("strong", {}, (typeof home.wins_others_pct === 'number' ? percent(home.wins_others_pct) : '-')),
          ]),
          h("div", { class: "stat" }, [
            "Draw / Draw Others: ",
            h("strong", {}, (typeof home.draws_pct === 'number' ? percent(home.draws_pct) : '-')),
            " / ",
            h("strong", {}, (typeof home.draws_others_pct === 'number' ? percent(home.draws_others_pct) : '-')),
          ]),
          h("div", { class: "stat" }, [
            "Lost / Lost Others: ",
            h("strong", {}, (typeof home.losses_pct === 'number' ? percent(home.losses_pct) : '-')),
            " / ",
      ...
      h("div", { class: "stats-col" }, [
        ...
        ...(awayN > 0 ? [
          ...
          h("div", { class: "stat" }, ["Average Goals Scored: ", h("strong", {}, away.avg_goals_scored != null ? away.avg_goals_scored.toFixed(2) : '-')]),
          h("div", { class: "stat" }, ["Average Goals Conceded: ", h("strong", {}, away.avg_goals_conceded != null ? away.avg_goals_conceded.toFixed(2) : '-')]),
          h("div", { class: "stat" }, ["Home 2+ Goals Scored: ", h("strong", {}, (typeof away.home_scored_2plus_pct === 'number' ? percent(away.home_scored_2plus_pct) : '-'))]),
          h("div", { class: "stat" }, ["Away 2+ Goals Scored: ", h("strong", {}, (typeof away.away_scored_2plus_pct === 'number' ? percent(away.away_scored_2plus_pct) : '-'))]),
          h("div", { class: "stat" }, [
            "Win / Win Others: ",
            h("strong", {}, (typeof away.wins_pct === 'number' ? percent(away.wins_pct) : '-')),
            " / ",
            h("strong", {}, (typeof away.wins_others_pct === 'number' ? percent(away.wins_others_pct) : '-')),
          ]),
          h("div", { class: "stat" }, [
            "Draw / Draw Others: ",
            h("strong", {}, (typeof away.draws_pct === 'number' ? percent(away.draws_pct) : '-')),
            " / ",
            h("strong", {}, (typeof away.draws_others_pct === 'number' ? percent(away.draws_others_pct) : '-')),
          ]),
          h("div", { class: "stat" }, [
            "Lost / Lost Others: ",
            h("strong", {}, (typeof away.losses_pct === 'number' ? percent(away.losses_pct) : '-')),
            " / ",
      ...
      ...(leagueScope.length ? leagueScope.map(bl => {
        ...
        return h("div", { class: "stats-col" }, [
          ...
          ...(n > 0 ? [
            ...
            h("div", { class: "stat" }, ["Average Goals (Home): ", h("strong", {}, (bl.avg_goals_home != null ? Number(bl.avg_goals_home).toFixed(2) : '-'))]),
            h("div", { class: "stat" }, ["Average Goals (Away): ", h("strong", {}, (bl.avg_goals_away != null ? Number(bl.avg_goals_away).toFixed(2) : '-'))]),
            h("div", { class: "stat" }, ["Home 2+ Goals Scored: ", h("strong", {}, pct(bl.home_scored_2plus_pct))]),
            h("div", { class: "stat" }, ["Away 2+ Goals Scored: ", h("strong", {}, pct(bl.away_scored_2plus_pct))]),
            h("div", { class: "stat" }, [
              "Home Win / Home Win Others: ",
              h("strong", {}, pct(bl.home_win_pct)),
              " / ",
              h("strong", {}, pct(bl.home_win_others_pct)),
            ]),
            h("div", { class: "stat" }, [
              "Draw / Draw Others: ",
              h("strong", {}, pct(bl.draw_pct)),
              " / ",
              h("strong", {}, pct(bl.draw_others_pct)),
            ]),
            h("div", { class: "stat" }, [
              "Away Win / Away Win Others: ",
              h("strong", {}, pct(bl.away_win_pct)),
              " / ",
